  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto flex items-center justify-center">
          ...
          <div className="text-center max-w-md flex flex-col justify-center items-center my-3">
            <div className="relative about-section__img overflow-hidden w-60 h-60  rounded-full">
              <img className=" rounded-full absolute object-cover w-full h-full mb-2" src={Diplomer} alt="" />
            </div>
            <div>
              <h1 style={{color: '#003667'}} className="text-xl font-bold mt-2">Diplômes accrédités</h1>
          ...
          <div className="text-center max-w-md flex flex-col justify-center items-center my-3">
            <div className="relative about-section__img overflow-hidden w-60 h-60  rounded-full">
              <img className=" rounded-full absolute object-cover w-full h-full mb-2" src={Mentor} alt="" />
            </div>
            <div>
              <h1 style={{color: '#003667'}} className="text-xl font-bold mt-2">Mentorat & Accompagnement</h1>
              <p className="w-8/12 text-gray-500 mx-auto mt-2">
          ...
          <div className="text-center max-w-md flex flex-col justify-center items-center my-3">
            <div className="relative about-section__img overflow-hidden w-60 h-60  rounded-full">
              <img className=" rounded-full absolute object-cover w-full h-full mb-2" src={Belle} alt="" />
            </div>
            <div>
              <h1 style={{color: '#003667'}} className="text-xl font-bold mt-2">Embauché ou remboursé</h1>
              <p className="w-8/12 text-gray-500 mx-auto mt-2">
      ...
      <div className="py-20 bg-white temoignage-section">
        <div className="container mx-auto text-center flex justify-center flex-col items-center">
          <h1 style={{color: '#003667'}}  className="mb-2 text-3xl font-semibold">Nos étudiants témoignent</h1>
          <div className="mt-6 flex items-start">
            <div className="temoignage-section__img flex-none mr-5"></div>
            <div className="py-4 max-w-lg text-left leading-8 -translate-y-4" style={{color: '#003667'}}>
              <div>
               « La formation Tech Lead d'OpenClassrooms est réellement en accord avec le monde de 
               l'entreprise. Il était aussi important que la formation soit au niveau Bac +5, car j'avais déjà un Bac +3 :
                je ne suis pas déçu du tout, car l’apprentissage est progressif avec l’aide des mentors. »
              </div>
              <footer >
                <cite className="text-xl font-semibold mt-6 inline-block" style={{color: '#003667'}}  >Calange<br/>Tech Lead</cite>
                <div className="">
                  <button className=" flex items-center mt-4" type="button" role="button" >
                    <svg fill="#8B5CF5" className="w-8 h-8 mr-3 text-violet-600" focusable="false" viewBox="0 0 24 24" aria-hidden="true" data-testid="PlayCircleOutlineIcon">
                      <path className="text-violet-600" d="m10 16.5 6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>
                    </svg><span className="text-violet-600">Regardez la vidéo</span><span className="sc-bczRLJ kEeNDj MuiTouchRipple-root"></span>
                  </button>
                </div>
              </footer>
            </div>
          </div>
          <div className="max-w-md flex justify-around items-center mt-5">
            <span className="w-2 h-2 rounded-full bg-violet-600 mx-3 inline-block cursor-pointer"></span>
            <span className="w-2 h-2 rounded-full bg-violet-300 mx-3 inline-block cursor-pointer"></span>
            <span className="w-2 h-2 rounded-full bg-violet-300 mx-3 inline-block cursor-pointer"></span>
          </div>
        </div>
      </div>
